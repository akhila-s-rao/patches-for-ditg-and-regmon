...
struct info {
  ...
  //akhila
  //uint64_t tx_rpoch_s;
  //uint64_t tx_epoch_us;
  //uint64_t rx_epoch_s;
  //uint64_t rx_epoch_us;
};
    ...
    long txTime_Usec,long rxTime_Usec, int size)
{
	...
	//infos->tx_epoch_s = time1;
	//infos->tx_epoch_us = txTime_Usec;
	//infos->rx_epoch_s = time2;
	//infos->rx_epoch_us = rxTime_Usec;
	...
	//PRINTD(2,"TxTime : %lu ",(uint64_t)infos->tx_epoch_s*(uint64_t)1000000 + infos->tx_epoch_us);
	//PRINTD(2,"RxTime : %lu ",(uint64_t)infos->rx_epoch_s*(uint64_t)1000000 + infos->rx_epoch_us);
	PRINTD(2,"Size : %5u\n\n",infos->size);
    return 0;
}
